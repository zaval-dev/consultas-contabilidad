            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700 text-white">
                    ...
                    <section id="introduccion" class="my-8">
                        ...
                        <p class="mb-4">
                            La gestión de riesgos implica la identificación, evaluación y priorización de los riesgos, seguida de la aplicación de recursos para minimizar, monitorear y controlar la probabilidad o el impacto de eventos desafortunados.
                        </p>
                        <p class="mb-4">
                            Es crucial para garantizar la precisión de los estados financieros, proteger los activos de la empresa, asegurar el cumplimiento normativo y prevenir fraudes.
                        </p>
                    </section>
                    ...
                    <section id="tipos-riesgos" class="my-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div class="bg-slate-700 p-6 rounded-lg shadow-md">
                                ...
                                <p class="text-gray-300">Pérdidas financieras debido a factores internos y externos que afectan la capacidad de la empresa para cumplir sus obligaciones.</p>
                            </div>
                            <div class="bg-slate-700 p-6 rounded-lg shadow-md">
                                <div class="flex items-center mb-4">
                                ...
                                <p class="text-gray-300">Fallos en procesos internos, sistemas, personas o eventos externos, como errores humanos o fallos en sistemas informáticos.</p>
                            </div>
                            <div class="bg-slate-700 p-6 rounded-lg shadow-md">
                                <div class="flex items-center mb-4">
                                ...
                                <p class="text-gray-300">Incumplimiento de leyes y regulaciones, que puede resultar en sanciones legales.</p>
                            </div>
                            <div class="bg-slate-700 p-6 rounded-lg shadow-md">
                                <div class="flex items-center mb-4">
                                ...
                                <p class="text-gray-300">Decisiones empresariales que afectan la capacidad de la empresa para alcanzar sus objetivos.</p>
                            </div>
                            <div class="bg-slate-700 p-6 rounded-lg shadow-md">
                                <div class="flex items-center mb-4">
                                ...
                                <p class="text-gray-300">Posibilidad de daño a la imagen y reputación de la empresa, afectando la confianza de los clientes e inversores.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="identificacion-evaluacion" class="my-8">
                        ...
                        <div id="accordion-collapse" data-accordion="collapse">
                            <h2 id="accordion-collapse-heading-1">
                                <button type="button" class="flex items-center justify-between w-full p-4 font-medium text-left text-gray-500 bg-gray-800 border border-gray-700 rounded-t-lg focus:ring-4 focus:ring-gray-800"
                                    ...
                                    <svg data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l5 5a1 1 0 11-1.414 1.414L10 5.414 5.707 9.707a1 1 0 01-1.414-1.414l5-5A1 1 0 0110 3z" clip-rule="evenodd"></path>
                                    </svg>
                                </button>
                            </h2>
                            ...
                            <h2 id="accordion-collapse-heading-3">
                                <button type="button" class="flex items-center justify-between w-full p-4 font-medium text-left text-gray-500 bg-gray-800 border border-gray-700 rounded-b-lg focus:ring-4 focus:ring-gray-800"
                            ...
                            <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
                                <div class="p-4 font-light border border-t-0 border-gray-700 bg-gray-900">
                                    <p class="mb-4 text-gray-300">El análisis cualitativo consiste en evaluar el riesgo basado en la percepción de gravedad y probabilidad, mientras que el análisis cuantitativo calcula el riesgo a partir de datos concretos para estimar su impacto financiero.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="estrategias-respuesta" class="my-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div class="bg-gray-700 p-6 rounded-lg shadow-md">
                                ...
                                <p class="text-gray-300">Reducir la probabilidad o el impacto del riesgo. Ejemplo: Implementar verificaciones para reducir el riesgo de fraude.</p>
                            </div>
                            <div class="bg-gray-700 p-6 rounded-lg shadow-md">
                                <div class="flex items-center mb-4">
                                ...
                                <p class="text-gray-300">Pasar el riesgo a otra parte. Ejemplo: Contratar un seguro para protegerse contra pérdidas financieras.</p>
                            </div>
                            <div class="bg-gray-700 p-6 rounded-lg shadow-md">
                                <div class="flex items-center mb-4">
                                ...
                                <p class="text-gray-300">Reconocer el riesgo y planificar cómo manejarlo si ocurre. Ejemplo: Analizar el riesgo de fluctuaciones en el mercado de valores y planificar para posibles pérdidas.</p>
                            </div>
                            <div class="bg-gray-700 p-6 rounded-lg shadow-md">
                                <div class="flex items-center mb-4">
                                ...
                                <p class="text-gray-300">Evitar el riesgo eliminando la causa raíz. Ejemplo: Descontinuar un producto que tiene un alto riesgo de fallos de calidad.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="monitoreo-revision" class="my-8">
                        ...
                        <p class="mb-4">
                            El monitoreo de riesgos implica la revisión periódica de la efectividad de los controles de riesgo y la actualización de las evaluaciones de riesgos existentes.
                        </p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="bg-gray-800 p-6 rounded-lg shadow-md">
                                ...
                                <table class="probabilidad-impacto-table w-full text-gray-800">
                                    <tr>
                                        <th rowspan="6" class="vertical-text bg-gray-700 text-white">Probabilidad</th>
                                        <th></th>
                                    ...
                                    <tr>
                                        <td class="text-xs bg-gray-700 text-white">Alta <span class="text-transparent">span</span></td>
                                    ...
                                    <tr>
                                        <td class="text-xs bg-gray-700 text-white">Media <span class="text-transparent">span</span></td>
                                        <td class="moderate-risk"></td>
                                        <td class="moderate-risk"></td>
                                        <td class="high-risk"></td>
                                        <td class="very-high-risk"></td>
                    ...
                    <section id="normas-regulaciones" class="my-8">
                        ...
                        <div id="accordion-collapse-1" data-accordion="collapse">
                            ...
                            <div id="accordion-collapse-body-4" class="hidden" aria-labelledby="accordion-collapse-heading-4">
                                <div class="p-4 font-light border border-t-0 border-gray-700 bg-gray-900">
                                    <ul class="list-disc list-inside text-gray-300">
                                        <li class="mb-2"><strong>ISO 31000:</strong> Proporciona principios y directrices generales para la gestión de riesgos.</li>
                                        <li class="mb-2"><strong>COSO:</strong> Marco para gestionar el riesgo empresarial, centrado en la identificación y gestión de riesgos.</li>
                                        <li class="mb-2"><strong>ISO/IEC 27005:</strong> Específico para la gestión de riesgos en seguridad de la información, complementando a ISO/IEC 27001.</li>
                                    </ul>
                                </div>
                            </div>
                            <h2 id="accordion-collapse-heading-5">
                                <button type="button" class="flex items-center justify-between w-full p-4 font-medium text-left text-gray-500 bg-gray-800 border border-gray-700 focus:ring-4 focus:ring-gray-800"
                                    data-accordion-target="#accordion-collapse-body-5" aria-expanded="false" aria-controls="accordion-collapse-body-5">
                            ...
                            <div id="accordion-collapse-body-5" class="hidden" aria-labelledby="accordion-collapse-heading-5">
                                <div class="p-4 font-light border border-t-0 border-gray-700 bg-gray-900">
                                    <p class="mb-4 text-gray-300">El cumplimiento de las regulaciones y leyes locales e internacionales es fundamental en la gestión de riesgos. Esto incluye:</p>
                                    <ul class="list-disc list-inside text-gray-300">
                                        <li class="mb-2">Regulaciones sectoriales específicas de cada industria.</li>
                                        <li class="mb-2">Leyes nacionales e internacionales, como el GDPR en Europa.</li>
                                        <li class="mb-2">Requisitos específicos del país en el que operan las empresas.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
