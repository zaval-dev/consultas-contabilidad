<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
                        ...
                        <div class="cursor-pointer transition-all duration-500 hover:-translate-y-2 hover:bg-blue-500 bg-blue-900 p-6 rounded-lg shadow-md text-center"
                            onclick="openModal('modal-entrada')">
                            <div class=" items-center justify-center">
                                <h4 class="text-2xl font-semibold text-white"><i
                                        class="fas fa-file-alt text-blue-400 text-2xl mr-4"></i>Etapa de Entrada
                                    (Insumos)</h4>
                            </div>
                        </div>

                        <!-- Card 2: Etapa de Emparejamiento -->
                        <div class="cursor-pointer transition-all duration-500 hover:-translate-y-2 hover:bg-red-500 bg-red-900 p-6 rounded-lg shadow-md text-center"
                            onclick="openModal('modal-emparejamiento')">
                            <div class=" items-center justify-center">
                                <h4 class="text-2xl font-semibold text-white"><i
                                        class="fas fa-project-diagram text-red-400 text-2xl mr-4"></i>Etapa de
                                    Emparejamiento</h4>
                            </div>
                        </div>

                        <!-- Card 3: Etapa de Salida -->
                        <div class="cursor-pointer transition-all duration-500 hover:-translate-y-2 hover:bg-yellow-500 bg-yellow-900 p-6 rounded-lg shadow-md text-center"
                            onclick="openModal('modal-salida')">
                            <div class=" items-center justify-center">
                                <h4 class="text-2xl font-semibold text-white"><i
                                        class="fas fa-check-circle text-yellow-400 text-2xl mr-4"></i>Etapa de Salida
                                    (Decisión)</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <section id="eleccion-estrategias" class="my-8">
                        <h2 class="text-3xl font-bold mb-4">Elección de Estrategias</h2>
            ...
            <section id="herramientas-estrategias" class="my-8">
